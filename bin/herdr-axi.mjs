...
const COMMAND_HELP = {
  ...
  read: "herdr-axi read <pane> [--lines N] [--chars N] [--compact] [--full]\n  Tail: 60 visible lines, 8000 characters. --compact removes border-only rows, padding, and repeated blank lines (layout changes).\n  --full: available history, 2000-line cap, no default character cap; may require a settled agent.",
