...
const RUN_HELP = {
  ...
  watch: `herdr-axi run watch [--task TASK] [--timeout-ms N]
  ...
  Prior report required and preserved. Unrecoverable report: --result-file FILE supplies an explicitly reviewed replacement (1..3500 chars).
